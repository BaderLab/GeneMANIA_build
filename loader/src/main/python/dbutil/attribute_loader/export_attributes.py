...
import unittest, tempfile, shutil, test_support
import process_identifiers, process_attributes, process_attribute_associations
import dbtools
import codecs
...
class AttributeExporter(object):
    ...
    def update_schema_file(self):
        ...
        logger.info("updating schema: '%s'" % schema_filename)
