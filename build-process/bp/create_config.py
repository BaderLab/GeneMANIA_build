...
def create_script_config(cfgfile):
	...
	bpcfg.write('MC_ORG="' + config['BuildScriptsConfig']['mc_org'] + '"\n')
	...
	bpcfg.write('GOURL="' + config['BuildScriptsConfig']['gourl'] + '"\n')
	bpcfg.write('EMAIL_TO="' + config['BuildScriptsConfig']['email_to'] + '"\n')
	bpcfg.write('SMTP_SERVER="' + config['BuildScriptsConfig']['smtp_server'] + '"\n')
	bpcfg.write('GOOGLE_U="' + config['BuildScriptsConfig']['google_u'] + '"\n')
	bpcfg.write('GOOGLE_P="' + config['BuildScriptsConfig']['google_p'] + '"\n')
	bpcfg.write('MYSQL_H="' + config['BuildScriptsConfig']['mysql_h'] + '"\n')
	bpcfg.write('MYSQL_U="' + config['BuildScriptsConfig']['mysql_u'] + '"\n')
	bpcfg.write('MYSQL_P="' + config['BuildScriptsConfig']['mysql_p'] + '"\n')
	bpcfg.write('IMPORT_ENSEMBL="' + config['BuildScriptsConfig']['import_ensembl'] + '"\n')
	bpcfg.write('IMPORT_ENTREZ="' + config['BuildScriptsConfig']['import_entrez'] + '"\n')
	bpcfg.write('IMPORT_PLANTS="' + config['BuildScriptsConfig']['import_plants'] + '"\n')
	bpcfg.write('IMPORT_METAZOA="' + config['BuildScriptsConfig']['import_metazoa'] + '"\n')
	bpcfg.write('IMPORT_BACTERIA="' + config['BuildScriptsConfig']['import_bacteria'] + '"\n')
	bpcfg.write('IMPORT_GO="' + config['BuildScriptsConfig']['import_go'] + '"\n')
	bpcfg.write('CREATE_DW="' + config['BuildScriptsConfig']['create_dw'] + '"\n')
